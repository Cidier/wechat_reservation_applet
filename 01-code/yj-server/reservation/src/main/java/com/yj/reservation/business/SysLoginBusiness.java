...
import com.yj.reservation.common.constant.CommonConst;
...
import com.yj.reservation.common.util.PhoneUtil;
...
public class SysLoginBusiness {
    ...
    private final MmSysUserServiceImpl userService;
    private final MmSysUserRoleRelationService userRoleRelationService;
    private final MmSysPermissionService permissionService;
...
//                permissionList = permissionService.listByUserRoleRelation(userRoleRelList);
            ...
            LoginInfo loginInfo = cacheSysUserInfo(user);
...
//            return JsonResult.success().put("userInfo", map).put("permissionList", permissionSet);
    ...
    private LoginInfo cacheSysUserInfo(MmSysUser user) {
        LoginInfo loginInfo = new LoginInfo();
        loginInfo.setUserId(user.getId());
        loginInfo.setUserName(user.getUserName());
//        loginInfo.setSysTag(user.getType());// 这里是sys
        loginInfo.setSysTag(CommonConst.SYS_TAG_SYS);
